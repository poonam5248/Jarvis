...
with open(r"D:\Jarvis\admin.csv",'r') as new_file:
...
f=open(r"D:\Jarvis\logs\test.txt", "a")
        ...
        if True:
            ...
            for face_encoding in face_encodings:
                ...
                if name not in v and name != "Unknown": 
                    ...
                    img_name = "D:\Jarvis\Jarvis"+xa+".png"
                    cv2.imwrite(img_name, frame)
                    myData = [xa,img_name]
                    with open(r"D:\Jarvis\admin.csv",'a') as csv_file:
